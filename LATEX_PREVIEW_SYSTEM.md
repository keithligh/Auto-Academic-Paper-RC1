...
-   **v1.8.2 Note**: Full Intent Engine (~450 lines) restored with all v1.5.x-v1.6.40 fixes.
-   **v1.6.41 Note**: FLAT intent now injects `font=\small` for diagrams with ≥5 nodes to prevent text overflow.
